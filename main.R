...
d2=read.csv("dji_per_day_data.csv",header=TRUE,sep=",",stringsAsFactors=FALSE)
# d2=read.csv("sp500_per_day_data.csv",header=TRUE,sep=",",stringsAsFactors=FALSE)
#d2=read.csv("nasdaq_per_day_data.csv",header=TRUE,sep=",",stringsAsFactors=FALSE)
...
# stdcrashdate = c("03/09/1929"); #crash of 1929
# stdcrashdate = c("25/08/1987"); #crash of 1987
# stdcrashdate = c("14/01/2000"); #crash of 2000
# stdcrashdate = c("02/5/2008");  #crash of 2008
stdcrashdate = c("16/4/2015");   #current date
...
# Note: choose parameter values such that, N_sensitivity > max(rwrange) + max(l_kw) + max(k_end) 
...
save_data(stock_precrash,ews_trends,kendall_histogram)
